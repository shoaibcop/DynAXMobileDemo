...
(function($) {
	var pluginName = 'gmap';
	var DATA_INITIAL_VIEW = "-6.194782, 106.821116, 10,10";
	...
	var commands = {
		...
		addMarkers: function(data) {
			...
			if (lat && lon) {
				var myLocation = new google.maps.LatLng(lat, lon);
				new google.maps.Marker({ map:map, position:myLocation, icon:"http://labs.google.com/ridefinder/images/mm_20_red.png" });
				bounds.extend(myLocation);
			}
